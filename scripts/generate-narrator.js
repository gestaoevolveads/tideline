...
- IMPORTANTE: escreva para a FAIXA da condição, não para o número decimal exato. O texto será reusado em dias com condição parecida, e o app mostra os números precisos por conta própria: por isso o texto NUNCA cita tamanho de onda (nem em metros, nem qualquer medida). Descreva o que o número não conta: a energia, o peso da remada, a pressão do drop, a exigência da onda. PERÍODO também qualitativo, pelo efeito (série espaçada/organizada vs apertada/atropelada), NUNCA em segundos (o card mostra). Energia idem, qualitativa.
- Use o perfil da praia (fundo, orientação, janela, maré, caráter) para contextualizar.
- NUNCA use "na/no/em + nome da praia" (a preposição certa muda por praia e errar soa péssimo; o app já mostra a praia). Fale da praia como sujeito ("O Forte acordou grande") ou não nomeie.
